...
REDIS_URI = os.environ["REDIS_URI"]  # Redis connection URI
...
WZ_LOG_FILE_PATH = pathlib.Path(os.getcwd(), "logs", f"ACCESS_{time.strftime('%Y-%m-%d')}.log")  # TODO: remove this, it serves no purpose
